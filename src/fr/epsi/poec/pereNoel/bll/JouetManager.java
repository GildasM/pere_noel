...
public class JouetManager {
	...
	/**
	 * Ajoute un jouet � la liste de jouet d'un enfant
	 * 
	 * @param nomJouet nom du jouet � ajouter � l'enfant
	 * @param enfant   enfant � qui on veut ajouter un jouet
